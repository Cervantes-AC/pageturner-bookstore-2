...
<div class="py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            ...
            <p class="mt-2 text-sm text-gray-600">Welcome back, {{ auth()->user()->name }}. Here's what's happening today.</p>
        </div>
                ...
                <div class="p-6">
                    @forelse($recentReviews as $review)
                        <div class="py-3 {{ !$loop->last ? 'border-b border-gray-100' : '' }}">
                            ...
                            <p class="text-xs text-gray-500 mb-1">{{ $review->book->title }}</p>
                            <p class="text-sm text-gray-600">{{ Str::limit($review->comment, 80) }}</p>
                        </div>
                    @empty
